<%-- 
    ...
    Created on : Dec 8, 2021, 5:27:59 PM
    Author     : Mladen
--%>
...
<%List<LoginHistory> loginHistoryList = (List<LoginHistory>) session.getAttribute("loginHistory");%>
...
<html class="bg-dark">
    ...
    <body class="bg-dark">
        ...
        <!-- NAVBAR END-->
        <h1 style="text-align: center; color: white; margin: 0;" class="bg-dark">User login history </h1>
        <p></p>
        <div class="container">
            <table class="table table-bordered table-light table-hover table-striped" style="text-align: center;" >
                ...
                <tr>
                    <td><%=item.getId()%></td>
                    <td><%=repo.getUserById(item.getUser())%></td>
                    <td><%=item.getLoginTime() == null ? "/" : item.getLoginTime()%></td>
