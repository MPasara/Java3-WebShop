...
public class UserProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<UserShoppingHistoryItem> userBillList = repo.getAllBillsOfUser(user);
            session.setAttribute("userBillList", userBillList);
            //repo.getUserShoppingHistory(user,billList);
            //repo.getUserShoppingHistory(user, bill);
