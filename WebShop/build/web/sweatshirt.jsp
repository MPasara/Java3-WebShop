...
<% List<Item> sweats = (List<Item>) (session.getAttribute("Sweatshirts"));%>
<!doctype html>
<html lang="en" >
    <head>
    ...
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="<%=c.getTitle().toLowerCase() == null ? "" : c.getTitle().toLowerCase()%>"><%=c.getTitle()%></a>
                            <%}%>
                        </div>
                    </li>
                    <%if (user == null) {%>
        ...
        <h1 style="text-align: center; color: white; margin: 0;" >Sweatshirts</h1>
        <%
            try {
                for (Item item : sweats) {
        %>
        <div class="row ">
            <div class="card " style="height: 20rem; border-radius: 1em; width: 17rem; margin: 1.5em;">
                ...
                <div class="card-body text-center">
                    <h5 style="color: black"><%=item.getItemName()%></h5>
                    <hr>
                    <h6 class="mb-3">
                        <span class="text-danger mr-1"><%=item.getPrice()%>$</span>
                    </h6>
                    <div class='main'>
                        <input type="number" class="form-control text-center" id="counter" style="width: 5em; margin-left: 6.5em;" value="1" min="1" max=<%=item.getAvailableAmount()%>>
                    </div>
                    <hr>
                    <div>
